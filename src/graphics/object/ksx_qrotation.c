...
// www.mathworks.com/help/nav/ug/rotations-orientation-and-quaternions.html
...
void	ksx_qrotation(t_vector3 *point, float angle, t_vector3 *p_v)
{
	...
	f[0] = angle * PI180;
	f[1] = sinf(f[0] * .5f);
	v4[0] = ksx_vec4_set(f[1] * p_v->x, f[1] * p_v->y,
			f[1] * p_v->z, cosf(f[0] * .5f));
...
static t_vector4	ksx_quat_multi(t_vector4 *p_q1, t_vector4 *p_q2)
{
	...
	v4.w = p_q1->w * p_q2->w - p_q1->x * p_q2->x
		- p_q1->y * p_q2->y - p_q1->z * p_q2->z;
	v4.x = p_q1->w * p_q2->x + p_q1->x * p_q2->w
		+ p_q1->y * p_q2->z - p_q1->z * p_q2->y;
	v4.y = p_q1->w * p_q2->y - p_q1->x * p_q2->z
		+ p_q1->y * p_q2->w + p_q1->z * p_q2->x;
	v4.z = p_q1->w * p_q2->z + p_q1->x * p_q2->y
		- p_q1->y * p_q2->x + p_q1->z * p_q2->w;
	return (v4);
}
