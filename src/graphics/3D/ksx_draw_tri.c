...
/*   Updated: 2025/02/18 14:16:18 by ksorokol         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		t_camera *p_camera)
{
	...
	pixel[0] = ksx_draw_get_pixel(p_camera, &p_tri->p_ver1->p_cp, p_tri->color.mlx_color);
	pixel[1] = ksx_draw_get_pixel(p_camera, &p_tri->p_ver2->p_cp, p_tri->color.mlx_color);
	pixel[2] = ksx_draw_get_pixel(p_camera, &p_tri->p_ver3->p_cp, p_tri->color.mlx_color);
